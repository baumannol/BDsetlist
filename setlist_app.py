# setlist_app_v2_0_8_mobile_fixed.py
# BD Setlist – Mobile-optimierte Variante (fixed)
# - Korrigierte Triple-Quote Strings (keine Backslash-Escapes)
# - Mobile-Modus mit Card-Layout, Farblogik, CSV/PDF Export
